        ...
        <div className="w-full h-full">
            <div className="flex justify-between items-center mb-10">
                <div className="flex flex-col justify-center">
                    <p className="text-lg">กระดานบันทึกที่รอเผยแพร่</p>
                    <p>Pending Blogs</p>
                </div>
                ...
                <table className="w-full">
                    <thead className="bg-gray-100 border-t border-b border-gray-200">
                        <tr>
                            ...
                            <th className="px-4 py-3 text-left text-md tracking-wider" style={{ width: '35%' }}>หัวข้อ</th>
                        ...
                        { currentBlogs.length ===  0 ? (
                            ...
                            currentBlogs.map((post, index) => (
                                <tr key={post._id} className="border-b border-gray-100 hover:bg-gray-50">
                                    ...
                                    { isAdmin && (<td className="px-4 py-3">{post.userId?.name || 'ไม่ระบุ' }</td>) }
